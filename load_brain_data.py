...
if __name__ == "__main__":
    data_dir= r"D:/intern_project_0830/MS_MDD_Harvard_FC_fisher-20250107T100946Z-001/MS_MDD_Harvard_FC_fisher"
    txt_file = r"D:/intern_project_0830/MDD_Harvard_site20-20250107T050634Z-001/MDD_Harvard_site20/20210331151631_MDD_site20_group/MDD_train_data_list_fold_1.txt"
    dataset = BrainDataset(txt_file, data_dir)
    print(f"총 샘플 수: {len(dataset)}")
    fc_data, label = dataset[0]
    print("\n=== BrainDataset 첫 샘플 예시 ===")
